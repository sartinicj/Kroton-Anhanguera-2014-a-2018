/* ***************************************************************/
/* Criando o Database SYSAMPLE                                    */
/*Script_01                                                                             */
/* Renata Leão & João Carlos da Silva                                */	
/* ***************************************************************/
/* Antes de criar este database crie o diretório C:\SistemaSQL 
Se você preferir utilizar outro disco que não a unidade C:\ não haverá problemas, mas
lembre-se de alterar o comando abaixo indicando a unidade de disco correta no comando
CREATE TABLE apresentado abaixo*/

/* ****************************************************************************/
/* com a extended Stored Procedure xp_cmdshell, criar o diretório */
/* SistemaSQL no disco C:\                                                                    */
/* ****************************************************************************/
Exec Master.dbo.xp_cmdshell 'MD C:\SistemaSQL\'
GO
/* ****************************************************************************/
/*Criando o Database SYSAMPLE                                                        */
/* ****************************************************************************/
CREATE DATABASE SYSAMPLE
ON PRIMARY
(
  NAME = 'SYSAMPLE_Data',
  FILENAME = 'C:\SistemaSQL\SYSAMPLE_Dados.mdf',
  SIZE = 10MB,
  MAXSIZE = 100MB,
  FILEGROWTH = 2MB
)
...
(
  NAME = 'SYSAMPLE_Log',
  FILENAME = 'C:\SistemaSQL\sSYSAMPLE_log.ldf',
  SIZE = 1MB,
  MAXSIZE = 10MB,
  FILEGROWTH = 1MB
)
